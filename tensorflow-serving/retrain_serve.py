...
def main(_):
  ...
  model_version = 1
  export_path = os.path.join("incept_retrain_serve", str(model_version))
  ...
  builder.add_meta_graph_and_variables(
    ...
    signature_def_map= {
      "flower_predict": tf.saved_model.signature_def_utils.predict_signature_def(
        inputs= {"image_input": jpeg_data_tensor},
        outputs= {"prediction": final_tensor})
        # method_name= tf.saved_model.signature_constants.PREDICT_METHOD_NAME)
    })
  builder.save()
